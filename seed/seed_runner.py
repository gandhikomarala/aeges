...
async def seed_database():
    ...
    docs = [
        ...
        ("doc_03", "Incident INC-2841 Post-Mortem", "Incident INC-2841 occurred on 2026-8-27. Deployment v2.8 for payment-service expected column stripe_customer_id on payments table, but migration 42_add_stripe_id.sql was omitted. Remediated by running alembic upgrade 42."),
